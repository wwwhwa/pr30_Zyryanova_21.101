...
public class FourActivity extends Activity {
    ...
    public final static String BROADCAST_ACTION = "com.example.pr30";
    ...
    public void onClickStart(View v) {
        ...
        intent = new Intent(this, ServiceForFour.class).putExtra(PARAM_TIME, 7)
                .putExtra(PARAM_TASK, TASK1_CODE);
        // стартуем сервис
        startService(intent);

        intent = new Intent(this, ServiceForFour.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_TASK, TASK2_CODE);
        startService(intent);

        intent = new Intent(this, ServiceForFour.class).putExtra(PARAM_TIME, 6)
